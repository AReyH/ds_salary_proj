...
def get_jobs(keyword, num_jobs, verbose,path):
    ...
    url = 'https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=&locT=&locId=&jobType=&context=Jobs&sc.keyword=data+science&dropdown=0'
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:  
            ...
            try:
                ...
                try:
                    size = driver.find_element_by_xpath('//*[@id="EmpBasicInfo"]/div[1]/div/div[1]/span').text
                except NoSuchElementException:
                    print('No size')
                    size = -1
